...
/* Using Linde Buzo Gray Algorithm - Euclidean Distance */
int main(int argc, char *argv[])
{
  ...
  mean1 = mean - 10*sqrt(variance);
  mean2 = mean + 10*sqrt(variance);

  do
  {
      printf("\n %lf %lf %lf %lf", mean1,mean2,variance1,variance2);
     for(i = 0;i < np;i++)
     {
